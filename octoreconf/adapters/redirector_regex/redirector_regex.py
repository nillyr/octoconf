...
from octoreconf.adapters.redirector_regex.output_redirector_regex_director import (
    OutputRedirectorRegexDirector,
)
from octoreconf.ports.redirector_regex.unix_output_redirector_regex_concrete_builder import (
    UnixOutputRedirectorRegexCB,
)
from octoreconf.ports.redirector_regex.windows_output_redirector_regex_concrete_builder import (
